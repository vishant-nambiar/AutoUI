...
while True:
    ...
    cv2.putText(frame_copy,'RIGHT',(438,30),cv2.FONT_HERSHEY_SIMPLEX,1,(165,42,42))

    #draw box for left (W)
    frame_copy = cv2.rectangle(frame_copy,(width//4,(height//2)+5),(3*width//4,3*height//4),(255,255,255),1)
    cv2.putText(frame_copy,'DOWN',(width//4,(height//2)+33),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255))

    #draw box for left (S)
    frame_copy = cv2.rectangle(frame_copy,(width//4,((3*height)//4)+5),(3*width//4,height),(255,255,255),1)
    cv2.putText(frame_copy,'UP',((3*width//4)-100,(height//2)+108),cv2.FONT_HERSHEY_SIMPLEX,1,(255,255,255))
